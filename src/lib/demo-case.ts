...
export const demoCase = {
  ...
  incident: {
    ...
    description:
      "Phone slipped from the customer's hand while being removed from a jacket pocket and fell approximately one metre onto a tiled kitchen floor.",
  },
  device: {
    make: "Apple",
  ...
  documents: [
    {
      id: "EVID-01",
      name: "customer-photo-01.png",
      type: "Damage photograph",
      status: "received",
      detail: "Full device visible; front-glass cracking is inspectable.",
    },
    {
      id: "EVID-02",
      ...
      status: "verified",
      detail: "Matches claimant, device model and purchase date.",
    },
    {
      id: "EVID-03",
      ...
      status: "received",
      detail: "Screen repair estimate: SEK 2,490 including VAT.",
    },
  ...
  timeline: [
    {
      ...
      detail: "Device dropped onto tiled floor at home.",
    },
    {
      time: "03 Aug, 09:42",
      title: "Claim submitted",
      detail: "Online claim form and three attachments received.",
    },
    {
      time: "03 Aug, 09:43",
      title: "Case created",
      detail: "Awaiting handler triage.",
    },
  ],
} as const;
...
export type AnalysisResult = {
  ...
  issues: Array<{
    type: "missing" | "contradiction" | "risk";
    title: string;
    detail: string;
