...
function workflowSummary(caseId: CaseId, stage: string, reviewState: string) {
  ...
  const summaries: Record<string, string> = {
    ...
    customer_replied: "The customer reply and rear-device photo have landed and are queued for evidence processing.",
    ...
    paused: "The evidence review is complete and the transparent customer email is prepared. The demo is paused for handler exploration before the synthetic email is sent.",
    estimate_incoming: "The revised estimate has landed and is queued for processing.",
