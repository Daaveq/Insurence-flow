...
function workflowSummary(caseId: CaseId, stage: string, reviewState: string) {
  ...
  const summaries: Record<string, string> = {
    ...
    request_sent: "The synthetic preparation request is shown as sent. The handler can inspect the evidence and drafting decisions before continuing the customer exchange. No real email was sent.",
    customer_typing: "The customer is shown composing a reply in the synthetic communication flow.",
    customer_replied: "The customer reply and rear-device photo have landed, and the agent continues automatically into the new-photo review.",
