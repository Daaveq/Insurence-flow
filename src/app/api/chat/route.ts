...
function workflowSummary(caseId: CaseId, stage: string, reviewState: string) {
  ...
  const summaries: Record<string, string> = {
    ...
    request_ready: "The fixed evidence review is complete and a transparent missing-information email is prepared. The agent remains visibly on the writing step until playback continues; nothing has been sent.",
    request_sent: "The synthetic preparation request is shown as sent and the customer exchange is continuing. No real email was sent.",
    customer_typing: "The customer is shown composing a reply in the synthetic communication flow.",
    customer_replied: "The customer reply and rear-device photo have landed, and the agent is visibly opening the new photo before its review continues.",
    ...
    paused: "The rear-device photo was acknowledged, and the agent is visibly monitoring for the revised estimate while the handler explores the first exchange.",
    estimate_incoming: "The revised estimate has landed, and the agent is visibly reading it before validation continues.",
